...
title: "AlexNet"
date: "2024-08-27"
description: "Training AlexNet from Scratch"
tags: ["AI/ML", "CNN"]
---
...
<ImageWithCaption src="/assets/img/blog/alexnet/alexnet.png" alt="AlexNet Architecture" caption="AlexNet Architecture. Credit to [Pinecone](https://www.pinecone.io/learn/series/image-search/imagenet/)." />
...
<ImageWithCaption
  src="/assets/img/blog/alexnet/alexnet_metrics.png"
  alt="AlexNet Training Metrics"
  caption="Training metrics (accuracy and loss) for AlexNet on Tiny ImageNet"
/>
